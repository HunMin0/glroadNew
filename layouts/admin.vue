                ...
                <v-card tile elevation="0" class="evertBox bgD">
                  <v-list-item-subtitle>
                    <v-list-item-title class="forTitle">
                      <v-icon color="#4c90bb" class="foicon">mdi-monitor-multiple</v-icon>&nbsp; Glroad Admin
                    </v-list-item-title>
                  </v-list-item-subtitle>
                </v-card>
              </v-card>
...
export default {
  ...
  data() {
    return {
      ...
      fixed: false,
      items: [
        {icon: 'mdi-account', title: '화주 회원관리', to: '/admin/members'},
        {icon: 'mdi-transit-transfer', title: '포워딩 회원관리', to: '/admin/forwardings'},
        {icon: 'mdi-calendar', title: '스케줄관리', to: '/admin/schedules'},
        {icon: 'mdi-credit-card-marker-outline', title: '결제관리', to: '/admin/payments'},
        {icon: 'mdi-file-document-edit', title: '계약관리', to: '/admin/contracts'},
        {icon: 'mdi-calculator-variant-outline', title: '정산관리', to: '/admin/adjustments'},
        {icon: 'mdi-bulletin-board', title: '게시판관리', to: '/admin/boards'},
        {icon: 'mdi-frequently-asked-questions', title: '문의내역', to: '/admin/questions'},
      ],
      Nitems: [
        {
          date: '오늘',
