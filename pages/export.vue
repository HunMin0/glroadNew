      ...
      <v-row>
        <v-spacer/>
         <v-col cols="11" xs="11" sm="10" md="8" lg="8" xl="6">
          <ul class="subNav">
            <li title="스케줄 조회"><router-link to="/procedure">스케줄 조회</router-link></li><!--
            --><li title="수출진행" class="activeLi"><router-link to="/export">수출진행</router-link></li>
          </ul>
        </v-col>
        <v-spacer/>
      </v-row>
