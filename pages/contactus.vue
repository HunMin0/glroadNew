                  ...
                  <v-col cols="11" xs="11" sm="10" md="8" lg="8" xl="6" class="qnaSet">
                    ...
                    <v-row class="textSetting">
                      <v-col cols="12" >
                        ...
                        <v-file-input label="파일첨부" class="inputStyle2"></v-file-input>
                    ...
                    <v-row class="text-center">
                      <v-col cols="12" >
                        <v-btn class="mr-4 btnStyle" large elevation="0" height="60">문의접수하기</v-btn>
                      </v-col>
                    </v-row>
                  </v-col>
                </v-row>
...
export default {
  ...
  data: () => ({
    headers: [
      {align: 'left', sortable: false, width: '80%', text: '', value: 'title'},
      {align: 'center', sortable: false, width: '20%', text: '', value: 'data-table-expand'},
    ],
    items: [],
  }),
  methods: {
