      ...
      <v-row>
        <v-spacer/>
         <v-col cols="12" xs="12" sm="10" md="8" lg="8" xl="6">
          <ul class="subNav">
            <li title="공지사항"><router-link to="/notices">공지사항</router-link></li><!--
            --><li title="자주묻는 질문" class="activeLi"><router-link to="/faqs">자주묻는 질문</router-link></li><!--
    ...
    <v-container fluid class="pa-0">
      ...
      <v-row align="center" justify="center">
        <v-col cols="11" xs="11" sm="10" md="8" lg="8" xl="7">
          ...
          <v-data-table :headers="headers" :items="items" disable-pagination hide-default-footer show-expand class="layouts-bottom axis">
...
export default {
  ...
  data: () => ({
    noticeitems: ['전체', '회원', '화물', '결제'],
    headers: [
      {align: 'center', sortable: false, width: '10%', text: '번호', value: 'num'},
      {align: 'left', sortable: false, width: '80%', text: '문의내용', value: 'title'},
  ...
  methods: {
    ...
    async init() {
      const response = await this.$axios.get('/board/2');
...
::v-deep .v-data-table > .v-data-table__wrapper tbody tr.v-data-table__expanded__content {box-shadow: none;}
...
::v-deep .axis .v-text-field {padding: 0 40px!important; font-size: 14px!important;}
